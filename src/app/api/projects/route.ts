...
const projects: TProjectExtra[] = [
  ...
  },
  {
    ...
    more_info: [
      {
        image: units.sever.default,
        text: '«Ориентир Запад» - высокотехнологичный индустриальный парк, объединяющий передовые технологии, современную инфраструктуру и комфортные условия для ведения бизнеса. Парк создан для компаний, которые стремятся к максимальной эффективности, инновациям и устойчивому развитию. Это пространство, где каждая деталь продумана для обеспечения высочайших стандартов качества и удобства.',
      },
      {
        image: units.sever.default,
        text: 'Современные производственные и складские объекты класса А+ спроектированы с учётом высоких стандартов и отвечают всем нормативным и техническим требованиям. Высота потолков позволяет использовать многоуровневые стеллажные системы и автоматизированное оборудование. Прочные конструкции из высококачественных материалов, обеспечивают долговечность и безопасность эксплуатации.',
      },
      {
        image: units.sever.default,
        text: 'Каждый объект оснащен собственной инженерной инфраструктурой, включая резервные источники питания, обеспечивающие бесперебойную работу комплекса. Современные системы вентиляции, кондиционирования и отопления, поддерживают оптимальный микроклимат в помещениях.',
      },
      {
        image: units.sever.default,
  ...
  },
  {
    ...
    description: 'Современное индустриальное пространство класса А с внедрением новейших технологий в области автоматизации складских процессов. В рамках развития инфраструктуры комплекса, реализуется строительство прямого съезда с федеральной трассы М-2 «Крым», благодаря чему стратегическое расположение вблизи трёх федеральных трасс даёт преимущество в скорости доставки.',
    full_description: 'Добавить полное описание', // ##
