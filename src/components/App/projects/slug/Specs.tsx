      ...
      <div className="grid grid-cols-2 sm:grid-cols-1 gap-y-10 xl:gap-y-8 px-44 xl:px-24 sm:px-0">
        {project.specifications.map((spec, index) => (
          <div key={index} className="space-y-10 xl:space-y-8">
            <div className="flex flex-col justify-between gap-24 xl:gap-16 sm:gap-10 px-10 xl:px-8 border-l-[1px] border-gray">
              <Heading type="h1" className="text-6xl xl:text-6xl sm:text-[44px] text-blue" text={spec.heading} />
