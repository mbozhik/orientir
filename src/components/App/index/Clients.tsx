  ...
  return (
    <section data-section="clients-index" className="space-y-14 sm:space-y-7">
      <div className="grid grid-cols-2 sm:grid-cols-1 sm:gap-3">
        <Typography type="h1" text="Клиенты" />
        <Typography type="h4" className="max-w-[50ch]" text="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean efficitur in odio sed rhoncus." />
      </div>
